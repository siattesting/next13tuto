...
const helper_1 = __webpack_require__(5097);
const types_1 = __webpack_require__(9090);
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>__awaiter(void 0, void 0, void 0, function*() {
                return yield (yield Promise.resolve().then(()=>__importStar(__webpack_require__(1580)))).fetch(...args);
            });
    } else {
        _fetch = fetch;
    }
...
var FunctionsClient_1 = __webpack_require__(1899);
...
var types_1 = __webpack_require__(9090);
...
const fetch_1 = __webpack_require__(5320);
const helpers_1 = __webpack_require__(945);
const errors_1 = __webpack_require__(4147);
     ...
     */ listUsers() {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if ((0, errors_1.isAuthError)(error1)) {
                    return {
                        data: {
                            users: []
                        },
...
const GoTrueAdminApi_1 = __importDefault(__webpack_require__(4074));
const constants_1 = __webpack_require__(4422);
const errors_1 = __webpack_require__(4147);
const fetch_1 = __webpack_require__(5320);
const helpers_1 = __webpack_require__(945);
const local_storage_1 = __importDefault(__webpack_require__(8639));
const polyfills_1 = __webpack_require__(9183);
     ...
     */ _initialize() {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            try {
                ...
                return {
                    error: new errors_1.AuthUnknownError("Unexpected error during initialization", error1)
                };
            } finally{
        ...
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if ("email" in credentials) {
                    ...
                    const { phone , password: password1 , options: options1  } = credentials;
                    res = yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/signup`, {
                        headers: this.headers,
                        body: {
                            phone,
        ...
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if ("phone" in credentials) {
                    const { phone , options: options1  } = credentials;
                    const { error: error1  } = yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/otp`, {
                        headers: this.headers,
                        body: {
                            phone,
        ...
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if (hasExpired) {
                    ...
                    const { data: data1 , error: error1  } = yield this.getUser(currentSession.access_token);
                    if (error1) {
                        throw error1;
                    }
                    session = {
     ...
     */ refreshSession(currentSession) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                const { session , error: error1  } = yield this._callRefreshToken(currentSession.refresh_token);
                if (error1) {
                    return {
                        data: {
                            user: null,
        ...
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if (error_description) {
                    ...
                    if (!error_code) throw new errors_1.AuthImplicitGrantRedirectError("No error_code detected.");
                    const error = (0, helpers_1.getParameterByName)("error");
                    if (!error) throw new errors_1.AuthImplicitGrantRedirectError("No error detected.");
                ...
                if (!access_token) throw new errors_1.AuthImplicitGrantRedirectError("No access_token detected.");
                const expires_in = (0, helpers_1.getParameterByName)("expires_in");
                if (!expires_in) throw new errors_1.AuthImplicitGrantRedirectError("No expires_in detected.");
                const refresh_token = (0, helpers_1.getParameterByName)("refresh_token");
                if (!refresh_token) throw new errors_1.AuthImplicitGrantRedirectError("No refresh_token detected.");
                const token_type = (0, helpers_1.getParameterByName)("token_type");
                if (!token_type) throw new errors_1.AuthImplicitGrantRedirectError("No token_type detected.");
                const timeNow = Math.round(Date.now() / 1000);
                const expires_at = timeNow + parseInt(expires_in);
                const { data , error: error1  } = yield this.getUser(access_token);
    ...
    _callRefreshToken(refreshToken) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            try {
                ...
                (_b = this.refreshingDeferred) === null || _b === void 0 ? void 0 : _b.reject(error1);
                throw error1;
            } finally{
                this.refreshingDeferred = null;
            }
...
const GoTrueClient_1 = __importDefault(__webpack_require__(451));
exports.GoTrueClient = GoTrueClient_1.default;
__exportStar(__webpack_require__(5346), exports);
__exportStar(__webpack_require__(4147), exports); //# sourceMappingURL=index.js.map
...
const version_1 = __webpack_require__(5340);
...
exports.AuthRetryableFetchError = AuthRetryableFetchError; //# sourceMappingURL=errors.js.map
...
exports.decodeJWTPayload = decodeJWTPayload; //# sourceMappingURL=helpers.js.map
...
exports.version = "2.2.1"; //# sourceMappingURL=version.js.map
...
const cross_fetch_1 = __importDefault(__webpack_require__(1580));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(1820));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(610));
const constants_1 = __webpack_require__(432);
/**
 * PostgREST client.
 *
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(3190));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(5064));
...
const version_1 = __webpack_require__(4719);
exports.DEFAULT_HEADERS = {
...
var PostgrestClient_1 = __webpack_require__(8480);
...
var PostgrestQueryBuilder_1 = __webpack_require__(1820);
...
var PostgrestFilterBuilder_1 = __webpack_require__(610);
...
var PostgrestTransformBuilder_1 = __webpack_require__(3190);
...
var PostgrestBuilder_1 = __webpack_require__(5064);
...
const constants_1 = __webpack_require__(6460);
const push_1 = __importDefault(__webpack_require__(1433));
const timer_1 = __importDefault(__webpack_require__(5615));
const RealtimePresence_1 = __importDefault(__webpack_require__(3359));
const Transformers = __importStar(__webpack_require__(5924));
            ...
            (_b = this.bindings[typeLower]) === null || _b === void 0 ? void 0 : _b.filter((bind)=>{
                ...
                if ([
                    ...
                    if ("id" in bind) {
                        ...
                        const bindEvent1 = (_e = (_d = bind === null || bind === void 0 ? void 0 : bind.filter) === null || _d === void 0 ? void 0 : _d.event) === null || _e === void 0 ? void 0 : _e.toLocaleLowerCase();
...
const websocket_1 = __webpack_require__(7182);
const constants_1 = __webpack_require__(6460);
const timer_1 = __importDefault(__webpack_require__(5615));
const serializer_1 = __importDefault(__webpack_require__(1010));
const RealtimeChannel_1 = __importDefault(__webpack_require__(8005));
const noop = ()=>{};
class RealtimeClient {
    ...
    /** @internal */ _throttle(callback, eventsPerSecondLimit = this.eventsPerSecondLimitMs) {
        return ()=>{
...
const RealtimeClient_1 = __importDefault(__webpack_require__(5695));
exports.RealtimeClient = RealtimeClient_1.default;
const RealtimeChannel_1 = __importStar(__webpack_require__(8005));
...
const RealtimePresence_1 = __importStar(__webpack_require__(3359));
...
const version_1 = __webpack_require__(4310);
exports.DEFAULT_HEADERS = {
...
exports.version = void 0;
exports.version = "2.1.0"; //# sourceMappingURL=version.js.map
...
const StorageFileApi_1 = __importDefault(__webpack_require__(7886));
const StorageBucketApi_1 = __importDefault(__webpack_require__(7937));
...
exports.StorageClient = void 0;
var StorageClient_1 = __webpack_require__(3591);
...
__exportStar(__webpack_require__(6448), exports);
__exportStar(__webpack_require__(3380), exports); //# sourceMappingURL=index.js.map
...
exports.DEFAULT_HEADERS = void 0;
const version_1 = __webpack_require__(674);
exports.DEFAULT_HEADERS = {
...
const errors_1 = __webpack_require__(3380);
const helpers_1 = __webpack_require__(3615);
const _getErrorMessage = (err)=>err.msg || err.message || err.error_description || err.error || JSON.stringify(err);
const handleError = (error, reject)=>__awaiter(void 0, void 0, void 0, function*() {
...
const resolveResponse = ()=>__awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            return (yield Promise.resolve().then(()=>__importStar(__webpack_require__(1580)))).Response;
        }
        return Response;
    });
...
exports.version = void 0;
// generated by genversion
exports.version = "2.0.0"; //# sourceMappingURL=version.js.map
...
const errors_1 = __webpack_require__(3380);
const fetch_1 = __webpack_require__(6980);
const helpers_1 = __webpack_require__(3615);
     ...
     */ uploadOrUpdate(method, path, fileBody, fileOptions) {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if ((0, errors_1.isStorageError)(error1)) {
                    return {
                        data: null,
                        error: error1
                    };
     ...
     */ createSignedUrl(path, expiresIn, options) {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                let data = yield (0, fetch_1.post)(this.fetch, `${this.url}/object/sign/${_path}`, {
                    expiresIn
                }, {
                    headers: this.headers
                });
...
const functions_js_1 = __webpack_require__(2034);
const postgrest_js_1 = __webpack_require__(1457);
const realtime_js_1 = __webpack_require__(5136);
const storage_js_1 = __webpack_require__(4646);
const constants_1 = __webpack_require__(1149);
const fetch_1 = __webpack_require__(633);
const helpers_1 = __webpack_require__(5068);
const SupabaseAuthClient_1 = __webpack_require__(6262);
...
const SupabaseClient_1 = __importDefault(__webpack_require__(1450));
__exportStar(__webpack_require__(2174), exports);
var functions_js_1 = __webpack_require__(2034);
Object.defineProperty(exports, "FunctionsHttpError", ({
    enumerable: true,
    get: function() {
...
__exportStar(__webpack_require__(5136), exports);
var SupabaseClient_2 = __webpack_require__(1450);
...
const gotrue_js_1 = __webpack_require__(2174);
...
exports.DEFAULT_HEADERS = void 0;
// constants.ts
const version_1 = __webpack_require__(4022);
exports.DEFAULT_HEADERS = {
...
const cross_fetch_1 = __importStar(__webpack_require__(1580));
const resolveFetch = (customFetch)=>{
    let _fetch;
    if (customFetch) {
        _fetch = customFetch;
...
exports.version = void 0;
exports.version = "2.0.4"; //# sourceMappingURL=version.js.map
...
try {
    module.exports = __webpack_require__(5076)(__dirname);
} catch (e) {
...
const nodeFetch = __webpack_require__(7075);
...
var whatwgUrl = _interopDefault(__webpack_require__(9799));
...
var mappingTable = __webpack_require__(3868);
 ...
 */ 
var isTypedArray = (__webpack_require__(8752).strict);
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var WebSocketClient = __webpack_require__(8055);
var toBuffer = __webpack_require__(5143);
var yaeti = __webpack_require__(6437);
const CONNECTING = 0;
const OPEN = 1;
const CLOSING = 2;
const CLOSED = 3;
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var utils = __webpack_require__(9161);
...
var WebSocketConnection = __webpack_require__(8960);
...
var utils = __webpack_require__(9161);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketFrame = __webpack_require__(444);
var BufferList = __webpack_require__(1858);
var isValidUTF8 = __webpack_require__(8259);
var bufferAllocUnsafe = utils.bufferAllocUnsafe;
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var bufferUtil = __webpack_require__(5302);
var bufferAllocUnsafe = (__webpack_require__(9161).bufferAllocUnsafe);
 ...
 *  limitations under the License.
 ***********************************************************************/ 
var extend = (__webpack_require__(9161).extend);
var util = __webpack_require__(3837);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRouterRequest = __webpack_require__(3585);
...
var utils = __webpack_require__(9161);
var util = __webpack_require__(3837);
var debug = __webpack_require__(8304)("websocket:server");
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRequest = __webpack_require__(7881);
...
exports.eventEmitterListenerCount = (__webpack_require__(2361).EventEmitter.listenerCount) || function(emitter, type) {
...
exports.BufferingLogger = function createBufferingLogger(identifier, uniqueID) {
    var logFunction = __webpack_require__(8304)(identifier);
...
module.exports = __webpack_require__(3927).version;
...
module.exports = {
    "server": __webpack_require__(2220),
    "client": __webpack_require__(8055),
    "router": __webpack_require__(5020),
    "frame": __webpack_require__(444),
    "request": __webpack_require__(7881),
    "connection": __webpack_require__(8960),
    "w3cwebsocket": __webpack_require__(253),
    "deprecation": __webpack_require__(8516),
    "version": __webpack_require__(5337)
};
 ...
 */ 
exports = module.exports = __webpack_require__(7297);
exports.log = log;
...
exports.humanize = __webpack_require__(2252);
/**
...
if (typeof process !== "undefined" && process.type === "renderer") {
    module.exports = __webpack_require__(4439);
} else {
    module.exports = __webpack_require__(9650);
}
...
const usm = __webpack_require__(9520);
...
const conversions = __webpack_require__(1232);
const utils = __webpack_require__(9089);
const Impl = __webpack_require__(5365);
...
exports.URL = __webpack_require__(791)["interface"];
exports.serializeURL = __webpack_require__(9520).serializeURL;
exports.serializeURLOrigin = __webpack_require__(9520).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(9520).basicURLParse;
exports.setTheUsername = __webpack_require__(9520).setTheUsername;
exports.setThePassword = __webpack_require__(9520).setThePassword;
exports.serializeHost = __webpack_require__(9520).serializeHost;
exports.serializeInteger = __webpack_require__(9520).serializeInteger;
exports.parseURL = __webpack_require__(9520).parseURL;
...
const tr46 = __webpack_require__(5658);
...
function URLStateMachine(input, base, encodingOverride, url, stateOverride) {
    ...
    const res1 = trimTabAndNewline(this.input);
    if (res1 !== this.input) {
        this.parseError = true;
    }
    this.input = res1;
...
URLStateMachine.prototype["parse hostname"] = URLStateMachine.prototype["parse host"] = function parseHostName(c, cStr) {
    if (this.stateOverride && this.url.scheme === "file") {
        ...
        const host1 = parseHost(this.buffer, isSpecial(this.url));
        if (host1 === failure) {
            return failure;
        }
        this.url.host = host1;
...
module.exports = {
    EventTarget: __webpack_require__(659),
    Event: __webpack_require__(4884)
};
