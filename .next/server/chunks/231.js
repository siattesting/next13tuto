...
const resolveFetch = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(() => __importStar(__webpack_require__(7528)))).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
var FunctionsClient_1 = __webpack_require__(8666);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const fetch_1 = __webpack_require__(2075);
const helpers_1 = __webpack_require__(492);
const errors_1 = __webpack_require__(9891);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const GoTrueAdminApi_1 = __importDefault(__webpack_require__(6954));
const constants_1 = __webpack_require__(9703);
const errors_1 = __webpack_require__(9891);
const fetch_1 = __webpack_require__(2075);
const helpers_1 = __webpack_require__(492);
const local_storage_1 = __importDefault(__webpack_require__(3330));
const polyfills_1 = __webpack_require__(3840);
...
const GoTrueClient_1 = __importDefault(__webpack_require__(5406));
exports.GoTrueClient = GoTrueClient_1.default;
__exportStar(__webpack_require__(5434), exports);
...
const version_1 = __webpack_require__(6532);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const cross_fetch_1 = __importDefault(__webpack_require__(7528));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(9397));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(6354));
const constants_1 = __webpack_require__(5440);
/**
 * PostgREST client.
 *
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(4364));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestBuilder_1 = __importDefault(__webpack_require__(5067));
...
const version_1 = __webpack_require__(1940);
...
var PostgrestClient_1 = __webpack_require__(5813);
...
var PostgrestQueryBuilder_1 = __webpack_require__(9397);
...
var PostgrestFilterBuilder_1 = __webpack_require__(6354);
...
var PostgrestTransformBuilder_1 = __webpack_require__(4364);
...
var PostgrestBuilder_1 = __webpack_require__(5067);
...
const push_1 = __importDefault(__webpack_require__(3917));
const timer_1 = __importDefault(__webpack_require__(8503));
const RealtimePresence_1 = __importDefault(__webpack_require__(7590));
const Transformers = __importStar(__webpack_require__(1921));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const websocket_1 = __webpack_require__(7975);
const constants_1 = __webpack_require__(6218);
const timer_1 = __importDefault(__webpack_require__(8503));
const serializer_1 = __importDefault(__webpack_require__(3148));
const RealtimeChannel_1 = __importDefault(__webpack_require__(7974));
const noop = () => { };
...
const RealtimeClient_1 = __importDefault(__webpack_require__(9230));
exports.RealtimeClient = RealtimeClient_1.default;
const RealtimeChannel_1 = __importStar(__webpack_require__(7974));
...
const RealtimePresence_1 = __importStar(__webpack_require__(7590));
...
const StorageFileApi_1 = __importDefault(__webpack_require__(301));
const StorageBucketApi_1 = __importDefault(__webpack_require__(7723));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.StorageClient = void 0;
var StorageClient_1 = __webpack_require__(6527);
Object.defineProperty(exports, "StorageClient", ({ enumerable: true, get: function () { return StorageClient_1.StorageClient; } }));
__exportStar(__webpack_require__(4849), exports);
__exportStar(__webpack_require__(4376), exports);
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DEFAULT_HEADERS = void 0;
const version_1 = __webpack_require__(5133);
...
const errors_1 = __webpack_require__(4376);
const helpers_1 = __webpack_require__(6562);
const _getErrorMessage = (err) => err.msg || err.message || err.error_description || err.error || JSON.stringify(err);
const handleError = (error, reject) => __awaiter(void 0, void 0, void 0, function* () {
...
const resolveResponse = () => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof Response === 'undefined') {
        return (yield Promise.resolve().then(() => __importStar(__webpack_require__(7528)))).Response;
    }
    return Response;
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const constants_1 = __webpack_require__(5038);
const errors_1 = __webpack_require__(4376);
const fetch_1 = __webpack_require__(9557);
const helpers_1 = __webpack_require__(6562);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const functions_js_1 = __webpack_require__(5197);
const postgrest_js_1 = __webpack_require__(844);
const realtime_js_1 = __webpack_require__(9626);
const storage_js_1 = __webpack_require__(5977);
const constants_1 = __webpack_require__(4134);
const fetch_1 = __webpack_require__(1685);
const helpers_1 = __webpack_require__(7970);
const SupabaseAuthClient_1 = __webpack_require__(9463);
...
const SupabaseClient_1 = __importDefault(__webpack_require__(2420));
__exportStar(__webpack_require__(2693), exports);
var functions_js_1 = __webpack_require__(5197);
...
__exportStar(__webpack_require__(9626), exports);
var SupabaseClient_2 = __webpack_require__(2420);
...
const gotrue_js_1 = __webpack_require__(2693);
...
exports.DEFAULT_HEADERS = void 0;
// constants.ts
const version_1 = __webpack_require__(9806);
...
const cross_fetch_1 = __importStar(__webpack_require__(7528));
const resolveFetch = (customFetch) => {
    let _fetch;
    if (customFetch) {
        _fetch = customFetch;
...
const nodeFetch = __webpack_require__(6876)
...
var whatwgUrl = _interopDefault(__webpack_require__(4551));
...
var mappingTable = __webpack_require__(2305);
...
var isTypedArray = (__webpack_require__(5059).strict)
...
module.exports = __webpack_require__(8791);
...
var WebSocketClient = __webpack_require__(7687);
var toBuffer = __webpack_require__(4420);
var yaeti = __webpack_require__(1553);
...
var utils = __webpack_require__(6204);
...
var WebSocketConnection = __webpack_require__(4448);
...
var utils = __webpack_require__(6204);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketFrame = __webpack_require__(427);
var BufferList = __webpack_require__(4249);
var isValidUTF8 = __webpack_require__(7505);
var bufferAllocUnsafe = utils.bufferAllocUnsafe;
...
var bufferUtil = __webpack_require__(5659);
var bufferAllocUnsafe = (__webpack_require__(6204).bufferAllocUnsafe);
...
var extend = (__webpack_require__(6204).extend);
var util = __webpack_require__(3837);
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRouterRequest = __webpack_require__(3296);
...
var utils = __webpack_require__(6204);
var util = __webpack_require__(3837);
var debug = __webpack_require__(775)('websocket:server');
var EventEmitter = (__webpack_require__(2361).EventEmitter);
var WebSocketRequest = __webpack_require__(453);
...
exports.BufferingLogger = function createBufferingLogger(identifier, uniqueID) {
    var logFunction = __webpack_require__(775)(identifier);
...
module.exports = __webpack_require__(7909).version;
...
module.exports = {
    'server'       : __webpack_require__(7235),
    'client'       : __webpack_require__(7687),
    'router'       : __webpack_require__(9338),
    'frame'        : __webpack_require__(427),
    'request'      : __webpack_require__(453),
    'connection'   : __webpack_require__(4448),
    'w3cwebsocket' : __webpack_require__(249),
    'deprecation'  : __webpack_require__(9229),
    'version'      : __webpack_require__(9914)
};
...
exports = module.exports = __webpack_require__(1367);
exports.log = log;
...
exports.humanize = __webpack_require__(9114);
...
if (typeof process !== 'undefined' && process.type === 'renderer') {
  module.exports = __webpack_require__(3378);
} else {
...
const usm = __webpack_require__(4125);
...
const conversions = __webpack_require__(4671);
const utils = __webpack_require__(5700);
const Impl = __webpack_require__(1986);
...
exports.URL = __webpack_require__(5832)["interface"];
exports.serializeURL = __webpack_require__(4125).serializeURL;
exports.serializeURLOrigin = __webpack_require__(4125).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(4125).basicURLParse;
exports.setTheUsername = __webpack_require__(4125).setTheUsername;
exports.setThePassword = __webpack_require__(4125).setThePassword;
exports.serializeHost = __webpack_require__(4125).serializeHost;
exports.serializeInteger = __webpack_require__(4125).serializeInteger;
exports.parseURL = __webpack_require__(4125).parseURL;
...
const tr46 = __webpack_require__(3310);
...
module.exports = {
	EventTarget : __webpack_require__(7386),
	Event       : __webpack_require__(3651)
};
